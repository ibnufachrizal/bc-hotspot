...
elseif($getsprice == "3000"){ $color = "#FF1493";}
elseif($getsprice == "5000"){ $color = "#8B008B";}
elseif($getsprice == "10000"){ $color = "#666";}
elseif($getsprice == "3000"){ $color = "#FF4500";}
elseif($getsprice == "50000"){ $color = "#E65100";}
...
Hubungkan ke wifi </br> AKSES WIFI </br>
Buka browser ketik: </br> akses-wifi.com 
</div>
</td>	
